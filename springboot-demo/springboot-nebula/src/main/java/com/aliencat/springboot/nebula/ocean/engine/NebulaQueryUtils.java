...
public class NebulaQueryUtils {
    ...
    public static void appendVertexId(GraphVertexType graphVertexType, StringBuilder sqlBuilder, Set<String> vertexIds) {
//        if (!CollectionUtils.isEmpty(vertexIds)){
//            vertexIds.parallelStream().forEach(vertexId->{
...
//        }
    ...
    private static void yieldWithDistinct(boolean distinct, GraphTypeManager graphTypeManager, StringBuilder sqlBuilder, String prefix, Class clazz, String... fields) {
        ...
        for (String field : fields) {
            ...
            if (fieldName.equals("id") || fieldName.equals("fromId") || fieldName.equals("toId")) {
                if (fieldName.equals("id")) {
                    temp.append("id(vertex)").append(" as ").append(propertyName);
                }
                if (fieldName.equals("fromId")) {
                    temp.append("src(edge)").append(" as ").append(propertyName);
                }
                if (fieldName.equals("toId")) {
                    temp.append("dst(edge)").append(" as ").append(propertyName);
                }
            } else {
