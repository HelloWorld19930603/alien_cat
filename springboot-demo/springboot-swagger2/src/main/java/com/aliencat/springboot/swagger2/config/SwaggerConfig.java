package com.aliencat.springboot.swagger2.config;
    ...
    public Docket controllerApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .contact(new Contact("aliencat", "http://localhost:8083/swagger-ui.html", ""))
                        .version("版本号:1.0")
                        .build())
                ...
                .select()
                //API基础扫描路径
                .apis(RequestHandlerSelectors.basePackage("com.aliencat.springboot.swagger2.controller"))
